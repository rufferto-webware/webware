...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../lib/datatables/FixedHeader-3.1.6/css/fixedHeader.dataTables.min.css">
	<style type="text/css" class="init">
	thead input {
		width: 100%;
	}
	</style>
	<script type="text/javascript" language="javascript" src="../lib/datatables/jquery-3.3.1.js"></script>
	<script type="text/javascript" language="javascript" src="../lib/datatables/DataTables-1.10.20/js/jquery.dataTables.min.js"></script>
	<script type="text/javascript" language="javascript" src="../lib/datatables/FixedHeader-3.1.6/js/dataTables.fixedHeader.min.js"></script>
