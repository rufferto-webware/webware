...
/// if session is gonne Error trap
if(empty($_SESSION['loc_mod']))			$_SESSION['loc_mod']='n-a';
if(empty($_SESSION['loc_tab']))			$_SESSION['loc_tab']='n-a';
if(empty($_SESSION['loc_page']))			$_SESSION['loc_page']='n-a';
